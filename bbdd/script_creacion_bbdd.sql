...
CREATE TABLE favoritos(
    ...
    FOREIGN KEY(usuario_id) REFERENCES usuario(id),
    sitios_id int,
    FOREIGN KEY(sitios_id) REFERENCES sitios(id),
...
(20, 'Casa de los Sitios', 'images/images_sitios/20_casaDeLosSitios.jpg', 'Por Ajzh2074 - Trabajo propio, CC BY-SA 3.0 es, https://commons.wikimedia.org/w/index.php?curid=21385817', 20),
(21, 'Museo del Foro de Caesaraugusta', 'images/images_sitios/21_foro_romano.jpeg', NULL, 21),
(22, 'Museo del Teatro de Caesaraugusta','images/images_sitios/22_museo_teatro_romano.jpg', NULL, 22),
(23, 'Palacio de los Condes de Argillo. Museo Pablo Gargallo', 'images/images_sitios/23_museo_pablo_gargallo.jpg', NULL, 23),
(24, 'Alma Mater Museum', 'images/images_sitios/24_alma_mater.jpg', NULL, 24),
(25, 'La Lonja', 'images/images_sitios/25_Lonja.jpg', NULL, 25),
(26, 'CaixaForum Zaragoza', 'images/images_sitios/26_caixaforum.jpg', NULL, 26),
(27, 'Patio de la Infanta', 'images/images_sitios/27_patio_infanta.jpg', NULL, 27),
(28, 'Centro de Historias de Zaragoza. Antiguo Convento de San Agustín', 'images/images_sitios/28_museo_historias.jpg', NULL, 28),
(29, 'Iglesia de San Pablo', 'images/images_sitios/29_sanpablo.jpg', NULL, 29),
(30, 'Iglesia Parroquial de Santa Maria Magdalena', 'images/images_sitios/30_iglesia_madalena.jpg', NULL, 30),
(31, 'Acuario de Zaragoza', 'images/images_sitios/31_acuario.jpg', NULL, 31),
-- (32, 'Parque de Atracciones', NULL, NULL, 32),
(32, 'Antiguo Convento de la Victoria. Museo del Fuego y de los Bomberos','images/images_sitios/32_museo_fuego.jpg', NULL, 32),
(33, 'Parque Metropolitano del Agua Luis Buñuel', 'images/images_sitios/33_parque_agua.jpg', NULL, 33),
(34, 'Museo de Ciencias Naturales de la Universidad de Zaragoza', 'images/images_sitios/34_paraninfo_museo_ciencias.jpg', NULL, 34),
(35, 'Museo de las Termas Públicas de Caesaraugusta', 'images/images_sitios/35_termas_romanas.jpg', NULL, 35),
(36, 'Museo del Puerto Fluvial de Caesaraugusta', 'images/images_sitios/36_puerto_fluvial.jpg', NULL, 36),
(37, 'Canal Imperial de Aragón', 'images/images_sitios/37_canal_imperial.jpg', NULL, 37);
