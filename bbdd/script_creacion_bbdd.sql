...
CREATE TABLE sitio (
    ...
    rampas enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    ascensores enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    puertas_automaticas enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    escaleras_mecanicas enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    servicios_adaptados enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    sala_lactancia enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    cambiador enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	parking_adaptado enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	bancos enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	mostrador_adaptado enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	sin_barreras_arquitectonicas enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	braille enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	interprete_lengua_signos enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    videos_subtitulos enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	ayudas_visuales enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    guias_turisticos_multiidioma enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    elementos_audiovisuales_multiidioma enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    documentacion_multiidioma enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    visitas_grupales enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	ayuda_movilidad enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
    lenguaje_simple enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	acceso_perros_guias enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información',
	acceso_perros_asistencia enum ('Sí', 'No', 'No hay información', 'Bajo petición') default 'No hay información'
);
...
NULL, NULL,	NULL, 'No hay información',	'No hay información', 
'Sí','No hay información', 'No hay información', 'No hay información', 'Sí', 
'Sí','Sí', 'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'No hay información',	'No hay información', 'Sí', 'Sí', 
'Sí', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información'),

(2, 'Palacio de la Aljafería', 675130.806,	4613775.045,NULL, 
NULL, NULL, NULL,'No hay información', 'Sí',
'Sí', 'No', 'No', 'No hay información', 'Sí', 
'Sí', 'Sí','No', 'No','No', 
'No hay información', 'No','No', 'Sí', 'Sí', 
'Sí', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información'),
...
(8, 'Torreon de la Zuda', 676383.363, 4613919.495, NULL, 
NULL, NULL, NULL,'No hay información', 'Sí',
'Sí', 'No', 'No', 'No hay información', 'Sí', 
'Sí', 'Sí', 'No', 'No', 'No', 
'No hay información', 'No', 'No', 'Sí', 'Sí', 
...
'976281998', 'https://www.mercadocentralzaragoza.com/', 'Sí', 'Sí', 'Sí', 'No', 'Sí', 'No', 'Sí','No', 'Sí','No',	
'Sí', 'No', 'No', 'No', 'No', 'Sí',	'No', 'No', 'Bajo petición','Sí','Sí', 'Sí','No'),

(11, 'Museo de Zaragoza: Secciones de Antigüedad y Bellas Artes', 676655.284, 4612891.748,
NULL, NULL, NULL, NULL,	'No hay información', 'Sí',	'Sí', 'No', 'No','No hay información', 'Sí','Sí', 'No', 'No', 'No',
'No hay información', 'No', 'No','Sí', 'Sí','Sí', 'No hay información', 'No hay información', 'No hay información',	'No hay información', 
'No hay información', 'No hay información'),

(12, 'Museo Goya - Colección Ibercaja',	676656.444,	4613612.917,	
NULL, NULL,	NULL, NULL, 'No hay información', 'Sí', 'Sí', 'No', 'No', 'No hay información', 'Sí','Sí', 'Sí','No', 'No', 
'No', 'No hay información', 'No', 'No', 'Sí', 'No', 'Sí', 'No hay información', 'No hay información', 'No hay información',	
'No hay información', 'No hay información'), 

(13, 'Parque Grande José Antonio Labordeta', 675325.621, 4611191.907,	
NULL, NULL, NULL, NULL, 'No hay información', 'Sí',	'Sí', 'No', 'No', 'No hay información', 'Sí', 'Sí', 'Sí', 'No', 'No',
'No', 'No hay información', 'No', 'No', 'Sí', 'Sí', 'Sí', 'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'No hay información'),

(14, 'Monumento a Goya', 676772.054, 4613722.752,
NULL, NULL,	NULL, NULL, 'No hay información', 'Sí', 'Sí', 'No', 'No', 'No hay información', 'Sí', 'Sí', 'Sí', 'No', 'No', 'No', 
'No hay información',
'No', 'No', 'Sí', 'Sí', 'Sí',	'No hay información', 'No hay información',	'No hay información', 'No hay información',	'No hay información'),
...
NULL, NULL,	NULL, NULL, 'No hay información', 'Sí',	'Sí', 'No', 'No','No hay información', 'Sí','Sí', 'Sí', 'No', 'No', 'No', 
'No hay información', 'No', 'No',	'Sí', 'Sí', 'Sí', 'No hay información',	'No hay información', 'No hay información', 'No hay información', 'No hay información'),

(17, 'Palacio de los Condes de Morata o Luna', 676219.034, 4613530.502,
NULL, NULL, NULL, NULL,	'No hay información', 'Sí', 'Sí','No', 'No', 'No hay información', 'Sí', 'Sí', 'Sí', 'No', 'No', 'No',	
'No hay información', 'Sí', 'No', 'Sí', 'Sí', 'Sí', 'No hay información', 'No hay información',	'No hay información', 'No hay información', 
'No hay información'),
...
NULL, NULL,	NULL, NULL,	'Sí', 'Sí', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 'Sí', 'Sí',	
'Sí', 'Sí',	'Sí', 'Sí', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'Sí', 'Sí', 'Sí', 'No hay información', 'No hay información'),

(21, 'Museo del Teatro de Caesaraugusta', 676745.991, 4613373.705,	
NULL, NULL, NULL, NULL, 'Sí', 'Sí', 'No hay información', 'No hay información',	'No hay información', 'No hay información', 'Sí', 'Sí',	'Sí', 
'Sí', 'Sí', 'Sí', 'Sí', 'No hay información', 'No hay información',	'Sí', 'Sí', 'No hay información', 'Sí',	'Sí', 'Sí', 'No hay información', 
'No hay información'),

(22, 'Palacio de los Condes de Argillo. Museo Pablo Gargallo', 676309.190, 4613618.596,
NULL, NULL,	NULL, NULL,	'No hay información', 'No hay información',	'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'No hay información', 'No hay información', 'Sí', 'Sí', 'Sí', 'No hay información','No hay información', 
'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'No hay información', 'No hay información', 'No hay información'),

(23, 'Alma Mater Museum', 676899.107, 4613712.996,	
NULL, NULL,	NULL, NULL,	'Sí', 'Sí',	'No hay información', 'No hay información', 'No hay información', 'No hay información', 'Sí', 'Sí',	
'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'Sí', 'Sí', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 'Sí', 'No hay información'),

(24,'La Lonja', 676473.690, 4613864.834,
NULL, NULL, NULL, NULL, 'Sí', 'No hay información', 'No hay información','No hay información', 'No hay información', 'No hay información', 
'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información','No hay información', 'No hay información', 'No hay información', 'No hay información', 'No hay información', 
'No hay información','No hay información', 
'No hay información', 'Sí', 'No hay información'),

(25, 'CaixaForum Zaragoza',	675356.535, 4613317.394,	
NULL, NULL,	NULL, NULL,	'No hay información', 'Sí',	'Sí', 'Sí', 'Sí', 'Sí',	'Sí', 'Sí',	'Sí', 'No hay información',	
'No hay información', 'No hay información',	'No hay información', 'Sí', 'No hay información', 'No hay información',	'Sí', 'Sí', 'No hay información', 
'No hay información', 'No hay información', 'Sí', 'Sí'),

(26, 'Patio de la Infanta', 676178.426, 4612781.704,	
NULL, NULL,	NULL, NULL, 'No hay información', 'No hay información',	'No hay información', 'No hay información',	'No hay información', 
'No hay información', 'No hay información', 'No hay información',	'No hay información', 'No hay información',	'Sí', 'No hay información', 
'No hay información','No hay información','No hay información','No hay información','No hay información','No hay información',
'No hay información','No hay información',
'No hay información', 'Sí', 'No hay información'),
...
NULL,NULL,NULL,NULL,'No hay información', 'No hay información',	'No hay información', 'No hay información',	'No hay información', 
'No hay información', 'No hay información', 'No hay información','No hay información', 'No hay información','No hay información', 'No hay información', 
'No hay información','No hay información','No hay información','No hay información','No hay información','No hay información',
'No hay información','No hay información', 'No hay información', 'No hay información', 'No hay información'),
...
NULL,NULL,NULL,NULL,'Sí','Sí','No hay información',	'No hay información','Sí','Sí','Sí','Sí','No hay información','No hay información',
'No hay información','Sí','No hay información','No hay información','No hay información','No hay información','No hay información',
'No hay información','Sí','No hay información','No hay información','No hay información','No hay información'),

(31, 'Antiguo Convento de la Victoria. Museo del Fuego y de los Bomberos',675987.540, 4613460.272	,
NULL,NULL,NULL,NULL,'Sí','Sí','No hay información','No hay información','Sí','Sí','Sí','No hay información','No hay información','No hay información',
'No hay información','No hay información','No hay información','No hay información','No hay información','No hay información','No hay información',
'Sí','No hay información','No hay información','No hay información','No hay información','Sí'),

(32, 'Parque Metropolitano del Agua Luis Buñuel',674469.478, 4615526.593	,
NULL,NULL,NULL,NULL,'Sí','No hay información','No hay información','No hay información','No hay información','No hay información','No hay información',
'No hay información','No hay información','No hay información', 'No hay información', 'No hay información',	'No hay información','No hay información',
'No hay información','No hay información','No hay información','No hay información','Sí','No hay información','No hay información','No hay información',
'No hay información'),

(33, 'Museo de Ciencias Naturales de la Universidad de Zaragoza',675984.774, 4612798.395	,
NULL, NULL, NULL, NULL, 'Sí', 'No hay información' ,'No hay información' ,'No hay información', 'No hay información', 'No hay información', 
'No hay información', 'No hay información', 'No hay información', 'No hay información', 'Sí',	
'No hay información', 'No hay información', 'No hay información', 'No hay información','Sí','Sí', 'Sí', 'No hay información', 'No hay información', 
'No hay información', 'Sí', 'No hay información'),
